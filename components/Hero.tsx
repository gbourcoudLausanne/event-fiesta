...
const PHOTOS = [
  { src: "/Galerie/hero-slides/hero-slide-1.webp", alt: "Arche de ballons rose et blanc au-dessus d'une table nappée de tulle" },
  { src: "/Galerie/hero-slides/hero-slide-2.webp", alt: "Arche organique rose poudré, crème et rose gold" },
  { src: "/Galerie/hero-slides/hero-slide-3.webp", alt: "Guirlande de ballons multicolore au-dessus d'une grazing table" },
  { src: "/Galerie/hero-slides/hero-slide-4.webp", alt: "Arche de ballons fleurs et rideau de franges terracotta, chiffre 3" },
  ...
  { src: "/Galerie/hero-slides/hero-slide-7.webp", alt: "Arche de cérémonie en bois avec voile ivoire drapé et compositions de fleurs séchées orangées" },
  ...
  { src: "/Galerie/hero-slides/hero-slide-10.webp", alt: "Chiffres 50 noirs et bouquets de ballons or, argent et noir" },
  { src: "/Galerie/hero-slides/hero-slide-11.webp", alt: "Table dressée en extérieur, chemin de table blanc, sous-assiettes dorées et centre floral" },
  { src: "/Galerie/hero-slides/hero-slide-12.webp", alt: "Chiffre 30 lumineux et arche de ballons blanc et or en extérieur" },
...
function PhotoWall({ columns = 3 }: { columns?: number }) {
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      {/* Fondu haut / bas : le mur se dissout dans le crème, sans cadre ni ombre */}
      <div
        className="absolute inset-x-0 top-0 h-40 pointer-events-none"
        style={{ background: "linear-gradient(#FAF7F2 8%, rgba(250,247,242,0))" }}
        aria-hidden
      />
      <div
        className="absolute inset-x-0 bottom-0 h-44 pointer-events-none"
        style={{ background: "linear-gradient(rgba(250,247,242,0), #FAF7F2 82%)" }}
        aria-hidden
      />
    </div>
  );
