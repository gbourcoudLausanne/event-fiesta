export const en = {
  ...
  contact: {
    ...
    steps: ["You", "The event", "Your budget", "Your vision", "Your inspiration"],
    you: {
      heading: "You",
      name: "First and last name",
      email: "Email address",
      phone: "Phone",
      phoneHint: "Optional — handy if I need to call you",
    },
    event: {
      heading: "The event",
      ...
      dateTbd: "Not set yet",
      venue: "Place or town",
      venuePlaceholder: "Lausanne, at home, village hall…",
      guests: "Number of guests",
      guestsOptions: ["Intimate (≤ 15)", "20 – 40", "40 – 80", "80 +"],
    },
    budget: {
      heading: "Your budget",
      note: "A rough range helps me suggest something realistic. Nothing is set in stone.",
      options: [
        { range: "Up to 300 CHF", hint: "A balloon bouquet, a nice arch, a few targeted touches." },
        { range: "300 – 700 CHF", hint: "A generous arch, the table dressed, a photo corner." },
        { range: "700 – 1500 CHF", hint: "Full décor: arch, sweet table, backdrop, props." },
        { range: "1500 CHF and up", hint: "Bespoke scenography, several areas, turnkey setup." },
      ],
      unsure: "I'd rather discuss it",
    },
    vision: {
      heading: "Your vision",
      message: "Describe what you have in mind",
      messagePlaceholder:
        "The theme, the colours, a mood, what matters to you, what to avoid…",
      mood: "A mood?",
      moodOptions: [
        "Boho",
        "Chic & elegant",
      ...
      palette: "Any colours?",
      paletteNote: "Pick the ones that speak to you",
      paletteOptions: [
        "Dusty pink",
        "Fuchsia",
        "Terracotta",
    ...
    inspiration: {
      heading: "Your inspiration",
      note: "A picture says a thousand words. Add images you like — Pinterest, Instagram, a setup you saw elsewhere.",
      upload: "Drop your photos here",
      uploadHint: "JPG, PNG or WebP · 5 files max · 5 MB total",
      uploadCta: "Choose files",
      tooLarge: "Files too large — send them to me on WhatsApp, it's easier.",
    ...
    submitting: "Sending…",
    disclaimer: "Reply within 24 h · Free quote, no obligation",
    altWhatsapp: "Or message me directly on WhatsApp",
    merci: {
      eyebrow: "Sent",
      title: "Thank you — I've received your request",
      text: "I'll get back to you within 24 h with a first idea and an estimate. If you have more photos to share, WhatsApp is the easiest way.",
      ref: "Your request number",
