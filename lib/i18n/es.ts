export const es = {
  ...
  services: {
    ...
    heroTitle: "Para cada ocasión, una decoración a medida",
  ...
  contact: {
    ...
    you: {
      ...
      phone: "Teléfono",
      phoneHint: "Opcional — útil si necesito llamarte",
    },
    event: {
      heading: "El evento",
      type: "¿Qué tipo de evento?",
      typeOptions: [
        "Cumpleaños",
        "Baby shower",
        "Gender reveal",
      ...
      date: "Fecha",
      dateTbd: "Aún sin fijar",
      venue: "Lugar o ciudad",
      venuePlaceholder: "Lausana, en casa, sala comunal…",
      guests: "Número de invitados",
      guestsOptions: ["Íntimo (≤ 15)", "20 – 40", "40 – 80", "80 +"],
    },
    budget: {
      heading: "Tu presupuesto",
      note: "Un rango aproximado me ayuda a proponerte algo realista. Nada es definitivo.",
      options: [
        { range: "Hasta 300 CHF", hint: "Un ramo de globos, un arco bonito, algunos toques puntuales." },
        { range: "300 – 700 CHF", hint: "Un arco generoso, la mesa decorada, un rincón de fotos." },
        { range: "700 – 1500 CHF", hint: "Decoración completa: arco, sweet table, backdrop, accesorios." },
        { range: "1500 CHF y +", hint: "Escenografía a medida, varios espacios, instalación llave en mano." },
      ],
      unsure: "Prefiero hablarlo",
    },
    vision: {
      heading: "Tu visión",
      message: "Describe lo que imaginas",
      messagePlaceholder:
        "El tema, los colores, un ambiente, lo que te importa, lo que quieres evitar…",
      mood: "¿Un ambiente?",
      moodOptions: [
        "Bohemio",
        "Chic y elegante",
      ...
      palette: "¿Colores?",
      paletteNote: "Selecciona los que te gusten",
      paletteOptions: [
        "Rosa empolvado",
        "Fucsia",
        "Terracota",
    ...
    inspiration: {
      heading: "Tus inspiraciones",
      note: "Una foto vale más que mil palabras. Añade imágenes que te gusten — Pinterest, Instagram, una decoración vista en otro sitio.",
      upload: "Suelta tus fotos aquí",
      uploadHint: "JPG, PNG o WebP · 5 archivos máx · 5 MB en total",
      uploadCta: "Elegir archivos",
      tooLarge: "Archivos demasiado pesados — envíamelos por WhatsApp, es más fácil.",
      links: "Enlaces de inspiración",
      linksPlaceholder: "https://pinterest.com/…",
      addLink: "Añadir un enlace",
    },
    submit: "Enviar mi solicitud",
    submitting: "Enviando…",
    disclaimer: "Respuesta en 24 h · Presupuesto gratuito y sin compromiso",
    altWhatsapp: "O escríbeme directamente por WhatsApp",
    merci: {
      eyebrow: "Enviado",
      title: "Gracias — he recibido tu solicitud",
      text: "Te respondo en 24 h con una primera idea y una estimación. Si tienes más fotos que compartir, WhatsApp es lo más fácil.",
      ref: "Tu número de solicitud",
